        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">JASA EKSPEDISI JAKARTA KE SELURUH INDONESIA</h2>
                <p class="animate__animated animate__fadeInUp">Kami siap menjadi mitra pengiriman dengan komunikasi yang baik, harga yang bersaing dan komitmen yang selalu kami jaga.</p>
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">JASA EKSPEDISI JAKARTA KE SELURUH INDONESIA</h2>
                <p class="animate__animated animate__fadeInUp">Siap membuka peluang kerjasama dengan pihak swasta, perorangan ataupun pemerintahan.</p>
                <a href="#about" class="btn-get-started animate__animated animate__fadeInUp scrollto">Get Started</a>
              </div>
            </div>
          </div>
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">JASA EKSPEDISI JAKARTA KE SELURUH INDONESIA</h2>
                <p class="animate__animated animate__fadeInUp">Kami siap membantu</p>
                <a href="#about" class="btn-get-started animate__animated animate__fadeInUp scrollto">Get Started</a>
              </div>
            </div>
          </div>
  ...
  <main id="main">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="">Cargo Darat</a></h4>
              <p class="description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Duis aute irure dolor in reprehenderit</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="">Cargo Udara</a></h4>
              <p class="description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Duis aute irure dolor in reprehenderit</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="">Cargo Laut</a></h4>
              <p class="description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Duis aute irure dolor in reprehenderit</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="">Pengiriman Mobil</a></h4>
              <p class="description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Duis aute irure dolor in reprehenderit</p>
            </div>
          </div>
        </div>
    ...
    <section class="cta">
      <div class="container">
        ...
        <div class="text-center">
          ...
          <p>Ingin bermitra bersama kami dalam pengiriman barang, ketentuan pengiriman atau pertanyaan lainnya? Silakan hubungi kami.</p>
    ...
    <section id="contact" class="contact section-bg">
          ...
          <div class="col-lg-6 d-flex align-items-stretch infos">
            ...
            <div class="row">
              ...
              <div class="col-lg-6 info d-flex flex-column align-items-stretch">
                <i class="bx bx-map"></i>
                <h4>KANTOR PUSAT</h4>
                <p>Wisma Sumatra Jaya<br>Jl. Kebon Kacang 5 No.80<br>Tanah Abang, Jakarta Pusat</p>
              </div>
              <div class="col-lg-6 info info-bg d-flex flex-column align-items-stretch">
                <i class="bx bx-map"></i>
                <h4>KANTOR CABANG</h4>
                <p>Jl. D.I. Panjaitan KM 7 No. 8<br>Tanjungpinang,<br>Kepulauan Riau</p>
              </div>
              <div class="col-lg-6 info info-bg d-flex flex-column align-items-stretch">
                <i class="bx bx-phone"></i>
                <h4>Hubungi kami</h4>
                <p>+62 812-9636-3178 (Pusat)<br>+62 813-6456-0914 (Cabang)<br>0812-7741-4276 (Cabang)</p>
              </div>
              <div class="col-lg-6 info d-flex flex-column align-items-stretch">
                <i class="bx bx-envelope"></i>
                <h4>Email</h4>
                <p>harddiescargo@gmail.com (Pusat)<br>sucimahdanibatu7@gmail.com (Cabang)</p>
              </div>
            </div>
      ...
      <div class="col-lg-6 d-flex">
          <div class="row">
            <div class="col-12">
              <div id="conatiner-map"><object style="border:0; height: 575px; width: 675px;"
              data="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d997.3268911232177!2d104.483764387993!3d0.9167952999580027!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31d96d9cce0d6f37%3A0x35c99dc9be90ad5d!2sSuci%20Mahdani%20Group!5e0!3m2!1sen!2sid!4v1600868025379!5m2!1sen!2sid"></object></div>
            </div>
          </div>
        </div>
    </div>
